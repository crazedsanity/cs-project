...
_CS-Project has been out-of-date for several years.  Currently, supporting libraries are in the process of being upgraded.  To ease the process, all feature requests and bug reports should be handled through GitHub's issue tracker._
